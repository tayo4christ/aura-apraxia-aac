...
title_label = tk.Label(
    root, text="🧠 Adaptive Speech Therapy", font=("Helvetica", 18, "bold")
)
title_label.pack(pady=10)

task_label = tk.Label(
    root, text="Press 'Next Task' to begin...", font=("Helvetica", 14)
)
...
next_button = tk.Button(
    root, text="Next Task", font=("Helvetica", 12), command=update_task
)
